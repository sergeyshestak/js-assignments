...
function encodeToRot13(str) {
    ...
    return str.split('').map(value => {
        if (value.charCodeAt() >= minUpper && value.charCodeAt() <= maxUpper){
            const charCode = (value.charCodeAt() + 13 > maxUpper)? value.charCodeAt() + 12 - maxUpper + minUpper: value.charCodeAt() + 13;
            return value = String.fromCharCode(charCode);
        }
        if (value.charCodeAt() >= minLower && value.charCodeAt() <= maxLower){
            const charCode = (value.charCodeAt() + 13 > maxLower)? value.charCodeAt() + 12 - maxLower + minLower: value.charCodeAt() + 13;
            return value = String.fromCharCode(charCode);
        }
        return value;
    }).join('');
